...
tgt_opts_types = {
    ...
    'lists'   : {"name"      : ([], 200, 'The name of the target, corresponding to the directory targets/name ; may provide a list if multiple targets have the same settings', 'All targets (important)'),
                 ...
                 "integrator" : ('',0, 'Integrator to be used', 'tinkerio'),
                  "barostat" : ('',0, 'Barostat to be used', 'tinkerio'),
    ...
    'ints'    : {"shots"              : (-1, 0, 'Number of snapshots; defaults to all of the snapshots', 'Energy + Force Matching', 'AbInitio'),
                 ...
                 "liquid_nbeads"      : (0,32, 'Set the number of beads for PIMD', 'tinkerio'),
                 "liquid_md_steps"    : (100000, 0, 'Number of time steps for the liquid production run.', 'Condensed phase property targets', 'liquid'),
                 "liquid_eq_steps"    : (10000, 0, 'Number of time steps for the liquid equilibration run.', 'Condensed phase property targets', 'liquid'),
                 "lipid_md_steps"     : (100000, 0, 'Number of time steps for the lipid production run.', 'Condensed phase property targets', 'lipid'),
                 "lipid_eq_steps"     : (10000, 0, 'Number of time steps for the lipid equilibration run.', 'Condensed phase property targets', 'lipid'),
                 ...
                 "gas_nbeads"         : (0,32, 'Set the number of beads for PIMD', 'tinkerio'),
                 "gas_md_steps"       : (1000000, 0, 'Number of time steps for the gas production run, if different from default.', 'Condensed phase property targets', 'liquid'),
                 "gas_eq_steps"       : (100000, 0, 'Number of time steps for the gas equilibration run, if different from default.', 'Condensed phase property targets', 'liquid'),
                 "nvt_md_steps"       : (1000000, 0, 'Number of time steps for the liquid NVT production run.', 'Condensed phase property targets', 'liquid'),
                 "nvt_eq_steps"       : (100000, 0, 'Number of time steps for the liquid NVT equilibration run.', 'Condensed phase property targets', 'liquid'),
    ...
    'bools'   : {"fdgrad"           : (0, -100, 'Finite difference gradient of objective function w/r.t. specified parameters', 'Use together with fd_ptypes (advanced usage)'),
                 ...
                 "pimd"             : (0, 1, 'Number of time steps for the liquid production run.', 'Condensed phase property targets', 'hydration'),
    ...
    'floats'  : {"weight"       : (1.0, 150, 'Weight of the target (determines its importance vs. other targets)', 'All targets (important)'),
                 ...
                 "a-axis"    : ('',50,'Length of the boxes', 'tinkerio'),
