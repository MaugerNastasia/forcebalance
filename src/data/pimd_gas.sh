...
do
  if ((i<=9))
  then
    mv gas_beads00$i.arc gas-md_beads00$i.arc
    /home/mauger/ForceBalance/ForceBalance_exec/analyze_ponder gas-md_beads00$i.arc -k gas-md.key G > G_beads00$i.out
    grep 'Total System Mass' G_beads00$i.out > Total_system_Mass_beads00$i.out
  fi
  if ((i>= 10))
  then
    mv gas_beads0$i.arc gas-md_beads0$i.arc
    /home/mauger/ForceBalance/ForceBalance_exec/analyze_ponder gas-md_beads0$i.arc -k gas-md.key G > G_beads0$i.out
...
do
  if ((i<=9))
  then
    /home/mauger/ForceBalance/ForceBalance_exec/analyze_ponder gas-md_beads00$i.arc -k gas-md.key E > E_beads00$i.out
  ...
  if ((i>=10))
  then
    /home/mauger/ForceBalance/ForceBalance_exec/analyze_ponder gas-md_beads0$i.arc -k gas-md.key E > E_beads0$i.out
...
do
  if ((i<=9))
  then
    mpirun -np 1 /home/mauger/ForceBalance/ForceBalance_exec/analyze gas-md_beads00$i.arc -k gas-md.key D > D_beads00$i.out
    grep 'Dipole X,Y,Z' D_beads00$i.out > Dipole_components_beads00$i.out
  fi
  if ((i>=10))
  then
    mpirun -np 1 /home/mauger/ForceBalance/ForceBalance_exec/analyze gas-md_beads0$i.arc -k gas-md.key D > D_beads0$i.out
